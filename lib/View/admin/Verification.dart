...
import 'package:doctor/View/admin/adminscreen.dart';
import 'package:doctor/ViewModel/services/navigation.dart';
import '../component/widgets.dart';

class AdminVerif extends StatelessWidget {
  AdminVerif({super.key});
                  ...
                  onCompleted: (value) {
                    if (value == "12345") {
                      toast(
                          ...
                          bcolor: Colors.green,
                          tcolor: Colors.white);
                      Navigation.gopushreplace(context, AdminScreen());
                    } else {
                      clear();
                      toast(
